        ...
        <div className="relative w-full">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    disabled={disabled}
                    className={`w-full h-8 pl-8 pr-20 text-sm bg-white border border-slate-400 shadow-sm rounded focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-600 text-slate-900 font-sans disabled:bg-slate-100 disabled:text-slate-400 disabled:border-slate-300 disabled:cursor-not-allowed ${className}`}
                />
